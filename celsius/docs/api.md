![API Key Overview](/assets/images/api-partner.svg)
{% raw %}
<h1 style="display: none;">API Key</h1>
{% endraw %}

## Use case

Celsius API Key partnership type is ideal for integrating existing Celsius Network users to third-party applications.
...
Please consult the [Postman docs](https://documenter.getpostman.com/view/4207695/Rzn6v2mZ#83677182-2cc9-4198-b574-77ad0862237b) for the API Key. 
